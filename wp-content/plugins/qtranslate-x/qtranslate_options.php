...
function qtranxf_default_locale()
{
	...
	$loc['zh'] = 'zh_CN';
	$loc['ru'] = 'ru_RU';
	$loc['fi'] = 'fi';//changed from fi_FI on Nov 10 2015 to match CMS locale
	$loc['fr'] = 'fr_FR';
	$loc['nl'] = 'nl_NL';
	$loc['sv'] = 'sv_SE';
	$loc['it'] = 'it_IT';
	...
	$loc['gl'] = 'gl_ES';
	$loc['tr'] = 'tr_TR';
	$loc['et'] = 'et';//changed from et_EE on Nov 10 2015 to match CMS locale
	$loc['hr'] = 'hr';//changed from hr_HR on Nov 10 2015 to match CMS locale
	$loc['eu'] = 'eu';//changed from eu_ES on Nov 10 2015 to match CMS locale
