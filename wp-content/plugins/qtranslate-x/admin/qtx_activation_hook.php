...
<?php
	...
	echo '</li><li>';
	printf(__('%sReview the plugin%s at CMS site.', 'qtranslate'), '<a href="https://wordpress.org/support/view/plugin-reviews/qtranslate-x?rate=5#postform" target="_blank">', '</a>');
	echo '</ul>';
	echo '</p><p>&nbsp;';
