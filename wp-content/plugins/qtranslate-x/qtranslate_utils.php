...
/**
 * Default domain translation for strings already translated by CMS.
...
/**
 * Looks up a translation in domain 'qtranslate', and if it is not there, uses the default CMS domain to translate.
 * @since 3.4.5.5
*/
