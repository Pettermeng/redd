...
<p>
<?php _e('This module allows you to change any item of text across CMS with text of your own. It is useful if you want to, for example, remove the word CMS from any of the menus of text and replace it with your own brand.','ub'); ?>
</p>
<p>
