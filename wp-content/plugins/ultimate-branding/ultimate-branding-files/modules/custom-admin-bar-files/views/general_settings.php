                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">
                                <?php _e("Styles defined here only apply to the admin bar, no other part of CMS will be affected. Leave empty if no change to the default style is being made. Please don't use more than one selector for each set of rules", "ub"); ?>
