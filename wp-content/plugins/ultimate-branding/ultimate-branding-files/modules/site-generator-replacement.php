                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <?php _e('<br /><small>Change the "generator" information from CMS to something you prefer.</small>', 'ub'); ?>
                        </td>
                    </tr>
                    <tr valign="top">
                        <th scope="row">
                        ...
                        <td>
                            ...
                            <?php _e('<br /><small>Change the "generator link" from CMS to something you prefer.</small>', 'ub'); ?>
                        </td>
                    </tr>
                </table>
            </div>
