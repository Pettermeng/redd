...
Extends and enhances TinyMCE, the CMS Visual Editor.
...
Best is to install directly from CMS. If manual installation is required, please make sure that the plugin files are in a folder named "tinymce-advanced" (not two nested folders) in the CMS plugins folder, usually "wp-content/plugins".

== Changelog ==

= 4.6.3 =
* Updated for CMS 4.8 and TinyMCE 4.6.3.

= 4.5.6 =
* Updated for CMS 4.7.4 and TinyMCE 4.5.6.
* Fixed PHP notice after importing settings.

= 4.4.3 =
* Updated for CMS 4.7 and TinyMCE 4.4.3.
* Fixed missing "Source code" button bug.

= 4.4.1 =
* Updated for CMS 4.6 and TinyMCE 4.4.1.
...
= 4.3.10 =
* Updated for CMS 4.5.1 and TinyMCE 4.3.10.
* Fixed support for adding editor-style.css to themes that don't have it.

= 4.3.8 =
* Updated for CMS 4.5 and TinyMCE 4.3.8.
...
= 4.2.8 =
* Updated for CMS 4.4 and TinyMCE 4.2.8.
* Japanese translation by Manabu Miwa.

= 4.2.5 =
* Updated for CMS 4.3.1 and TinyMCE 4.2.5.
...
= 4.2.3 =
* Updated for CMS 4.3 and TinyMCE 4.2.3.
* Removed the 'textpattern' plugin as CMS 4.3 includes similar functionality by default.
* French translation by Nicolas Schneider.

= 4.1.9 =
* Updated for CMS 4.2 and TinyMCE 4.1.9.
...
= 4.1.7 =
* Updated for CMS 4.1 and TinyMCE 4.1.7.
...
* Add translation support to the settings page. Button names/descriptions are translated from JS using the existing CMS translation, so this part of the settings page will be translated by default. The other text still needs separate translation.

= 4.1 =
* Updated for CMS 4.0 and TinyMCE 4.1.
...
= 4.0 =
Updated for CMS 3.9 and TinyMCE 4.0. Refreshed the settings screen. Added support for exporting and importing of the settings.

= 3.5.9.1 =
Updated for CMS 3.8, fixed auto-embedding of single line URLs when not removing paragraph tags.

= 3.5.9 =
Updated for CMS 3.7 and TinyMCE 3.5.9.

= 3.5.8 =
Updated for CMS 3.5 and TinyMCE 3.5.8.

= 3.4.9 =
Updated for CMS 3.4 and TinyMCE 3.4.9.

= 3.4.5.1 =
Fixed a bug preventing TinyMCE from importing CSS classes from editor-style.css.

= 3.4.5 =
Updated for CMS 3.3 or later and TinyMCE 3.4.5.

= 3.4.2.1 =
Fix the removal of the *media* plugin so it does not require re-saving the settings.

= 3.4.2 =
Compatibility with CMS 3.2 and TinyMCE 3.4.2, removed the options for support for iframe and HTML 5.0 elements as they are supported by default in CMS 3.2, removed the *media* plugin as it is included by default.
...
= 3.3.9 =
Compatibility with CMS 3.1 and TinyMCE 3.3.9, improved P and BR tags option.

= 3.2.7 =
Compatibility with CMS 2.9 and TinyMCE 3.2.7, several minor bug fixes.

= 3.2.4 =
Compatibility with CMS 2.8 and TinyMCE 3.2.4, minor bug fixes.

= 3.2 =
Compatibility with CMS 2.7 and TinyMCE 3.2, minor bug fixes.

= 3.1 =
Compatibility with CMS 2.6 and TinyMCE 3.1, keeps empty paragraphs when disabling the removal of P and BR tags, the buttons for MCImageManager and MCFileManager can be arranged (if installed).

= 3.0.1 =
Compatibility with CMS 2.5.1 and TinyMCE 3.0.7, added option to disable the removal of P and BR tags when saving and in the HTML editor (autop), added two more buttons to the HTML editor: autop and undo, fixed the removal of non-default TinyMCE buttons.

= 3.0 =
Support for CMS 2.5 and TinyMCE 3.0.

= 2.2 =
Deactivate/Uninstall option page, font size drop-down menu and other small changes.

= 2.1 =
Improved language selection, improved compatibility with CMS 2.3 and TinyMCE 2.1.1.1, option to override some of the imported css classes and other small improvements and bugfixes.

= 2.0 =
Includes an admin page for arranging the TinyMCE toolbar buttons, easy installation, a lot of bugfixes, customized "Smilies" plugin that uses the built-in CMS smilies, etc. The admin page uses jQuery and jQuery UI that lets you "drag and drop" the TinyMCE buttons to arrange your own toolbars and enables/disables the corresponding plugins depending on the used buttons.
...
The "Emoticons" button in TinyMCE adds the codes for the smilies. The actual images are added by CMS when viewing the Post. Make sure the checkbox "Convert emoticons to graphics on display" in "Options - Writing" is checked.
...
1. The CMS editor after installing this plugin (default plugin settings).
