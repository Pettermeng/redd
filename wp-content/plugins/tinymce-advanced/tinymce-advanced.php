...
Description: Enables advanced features and plugins in TinyMCE, the visual editor in CMS.
Version: 4.6.3
Author: Andrew Ozz
...
class Tinymce_Advanced {
	...
	public function warn_if_unsupported() {
		if ( ! $this->check_minimum_supported_version() ) {
			...
			printf( __( 'TinyMCE Advanced requires CMS version %1$s or newer. It appears that you are running %2$s. This can make the editor unstable.', 'tinymce-advanced' ),
			...
			printf( __( 'Please upgrade your CMS installation or download an <a href="%s">older version of the plugin</a>.', 'tinymce-advanced' ),
