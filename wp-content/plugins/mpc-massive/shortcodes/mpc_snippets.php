		...
		static function render_wc_product( $query ) {
			...
			if ( ! empty( $query ) ) {
				...
				if ( is_object( $variation_object ) && $variation_object->parent !== null ) {
					...
					$variation_id  = property_exists( $product_object, 'variation_id' ) ? $product_object->variation_id : $product_object->get_id();
					...
					$product_id    = property_exists( $product_object, 'id' ) ? $product_object->id : $product_object->get_id();
