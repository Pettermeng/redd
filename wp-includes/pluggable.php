 ...
 *
 * Some CMS functionality is based on the current user and not based on
...
function wp_new_user_notification( $user_id, $deprecated = null, $notify = '' ) {
	...
	wp_mail($user->user_email, sprintf(__('REDD+ Cambodia- registered as a redd+ project reviewer'), $blogname), $message);
