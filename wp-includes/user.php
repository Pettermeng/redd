...
/**
 * Authenticate the user using the CMS auth cookie.
 *
 * @since 2.8.0
 *
 * @global string $auth_secure_cookie
 ...
 *
 * @global wpdb $wpdb CMS database abstraction object.
 *
 ...
 * it will prepend the CMS table prefix to the option name.
 *
...
function wp_insert_user( $userdata ) {
	 ...
	 * @since 2.0.3
	 *
	 * @param string $middle_name The user's first name.
	 */
	$meta['middle_name'] = apply_filters( 'pre_user_first_name', $middle_name );
...
function _get_additional_user_keys( $user ) {
	$keys = array( 'first_name', 'middle_name','last_name', 'nickname', 'description', 'rich_editing', 'comment_shortcuts', 'admin_color', 'use_ssl', 'show_admin_bar_front', 'locale' );
 ...
 * @since 3.1.0
 *
 * @global wpdb         $wpdb      CMS database object for queries.
